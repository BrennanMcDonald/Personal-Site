...
export function IconBar() {
    return (
        <div className="social-bar">
            <a href="https://github.com/BrennanMcDonald" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
            ...
            <a href="https://linkedin.com/in/brennan-mcdonald" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="22" height="22">
